    ...
    return (
        <MessageContainer darkTheme={darkTheme} id={props.message.id}>
            <MessageBase>
                <img
                    src={
                        "https://cdn.discordapp.com/avatars/494187257041780746/c6f8d7b695d6fa2f101010be71f29818.png?size=256"
                    }
                    className="message-header-avatar w-12 h-12 rounded-full self-start border-slate-400 border-2 left-2 absolute m-2"
                    style={{
                ...
                <MessageHeader>
                    ...
                    {/* use lighter font */}
                    <h2
                        className={`message-header-time text-xs h-full ${
                    ...
                    <div className="message-header-options">
                        <div
                            className="message-header-right-options-item hover:text-green-400"
                            onClick={() =>
                ...
                <MessageBody>
                    <StyleParser
                        ...
                        hideModalDialog={props.hideModalDialog}
                    />
                </MessageBody>
            </MessageBase>
        </MessageContainer>
